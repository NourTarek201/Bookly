    ...
    public partial class all : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedEvent", x => new { x.EventId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_BookedEvent_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookedEvent_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedEvent_CustomerId",
                table: "BookedEvent",
                column: "CustomerId");
